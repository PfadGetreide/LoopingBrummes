...
// Constructor, sets the output pins for the motor control and initializes variables
...
// rndParam: if true, randomly changes speed and direction of the motor at random intervals
// rvrsParam: if true, sets the motor direction to reverse
...
uint8_t Control::getSpeed(){
  return actualSpeed;
}

// Returns the current direction of the motor (true for forward, false for backward)
